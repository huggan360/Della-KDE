#ifndef glass_helper_h
#define glass_helper_h
...
//* glass style helper class.
/** contains utility functions used at multiple places in both glass style and glass window decoration */
