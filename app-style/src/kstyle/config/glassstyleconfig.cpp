...
#include "glassstyleconfig.h"

#include "../config-glass.h"
#include "../glass.h"
#include "glassstyleconfigdata.h"
#include "glassstyleversion.h"
...
{
    return new Glass::StyleConfig(parent);
}
}
...
void StyleConfig::save()
{
    ...
    QDBusMessage message(
        QDBusMessage::createSignal(QStringLiteral("/GlassStyle"), QStringLiteral("org.kde.Glass.Style"), QStringLiteral("reparseConfiguration")));
...
void StyleConfig::load()
{
    ...
    _versionNumber->setText(GLASS_VERSION_STRING);
