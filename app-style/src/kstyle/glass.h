...
namespace PenWidth
{
/* Using 1 instead of sglass more than 1 causes symbols drawn with
...
Q_DECLARE_OPERATORS_FOR_FLAGS(Glass::AnimationModes)
Q_DECLARE_OPERATORS_FOR_FLAGS(Glass::AnimationParameters)
Q_DECLARE_OPERATORS_FOR_FLAGS(Glass::Corners)
Q_DECLARE_OPERATORS_FOR_FLAGS(Glass::Sides)
