...
const char PropertyNames::menuTitle[] = "_glass_toolButton_menutitle";
const char PropertyNames::alteredBackground[] = "_glass_altered_background";
const char PropertyNames::forceFrame[] = "_breeze_force_frame";
const char PropertyNames::bordersSides[] = "_breeze_borders_sides";
const char PropertyNames::noSeparator[] = "_glass_no_separator";
}
